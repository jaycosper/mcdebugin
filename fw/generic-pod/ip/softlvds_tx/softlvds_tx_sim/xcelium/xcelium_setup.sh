...
TOP_LEVEL_NAME="softlvds_tx"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/opt/altera/quartus_lite/25.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_soft_lvds/altera_soft_lvds_tx_uS1HUqyJ.v" -work softlvds_tx -cdslib ./cds_libs/softlvds_tx.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/softlvds_tx.v"                                                                                           
fi
